...
call:call_file "%%COLCON_CURRENT_PREFIX%%\share\collision_avoidance\hook\pythonpath.bat"
call:call_file "%%COLCON_CURRENT_PREFIX%%\share\collision_avoidance\hook\ament_prefix_path.bat"
